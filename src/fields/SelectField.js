...
import Select from 'modul-ui/Select';
...
class SelectField extends React.Component {
    ...
    static propTypes = {
        ...
        field: PropTypes.object,              // объект поля формы
    ...
    render() {
        const {type, placeholder, field, validator, className, ...props} = this.props;
        const classNames = `${ className } ${ validator.addClassName }`;
        const fieldBinds = {...field.bind({type, placeholder})};
        const clearable = props.clearable || false;
        fieldBinds.value = fieldBinds.value || null;
        return (
            <Select {...fieldBinds}
...
export default observer(radValidateHoc()(SelectField));
